...
def main() -> None:
    ...
    integration_root = artifact / "integration"
    ...
    for path in [integration_root / "home-card.css", integration_root / "home-inject.js"]:
        if not path.is_file():
    ...
    added_expected = {HOME_CSS, HOME_JS} | {
    ...
    report = {
        ...
        "physical_phone_qa": "PENDING_USER_VERIFICATION",
    }

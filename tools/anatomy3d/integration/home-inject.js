    ...
    return `
      <button id="${CARD_ID}" class="ftr-a3d-v56-card" type="button" aria-label="3D Anatomi modülünü aç">
        <span class="ftr-a3d-v56-copy">
          ...
          <span class="ftr-a3d-v56-sub">Kaslar • Sinirler • Ligamentler • Damarlar • Kemikler</span>
          <span class="ftr-a3d-v56-note">3D model üzerinde keşfet, öğren ve yapıyı incele!</span>
